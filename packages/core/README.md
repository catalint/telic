...
|---|---|
| [SPEC.md](SPEC.md) | **What** — the normative, clause-numbered contract the implementation and tests both cross-check against |
| [DESIGN.md](DESIGN.md) | **Why** — boundaries, risks, and the initiative boundary (never owns time or transport) |
| [PATTERNS.md](PATTERNS.md) | **How** — patterns (P1–P10) and anti-patterns (AP1–AP8) for using it well |
| [APPROACHES.md](APPROACHES.md) | **Which** — a per-axis decision guide when there's more than one reasonable option |
| [DECISIONS.md](DECISIONS.md) | **When / what changed** — the append-only log of design decisions and what was rejected |
| [Recipes](https://github.com/catalint/telic/tree/main/packages/core/docs/recipes) | **Worked examples** — full end-to-end wiring against a real vendor, starting with PostHog |
...
committed under semver; see [CHANGELOG.md](https://github.com/catalint/telic/blob/main/CHANGELOG.md). Emitted type declarations are
...
[MIT](https://github.com/catalint/telic/blob/main/LICENSE) © Catalin Tanasescu
